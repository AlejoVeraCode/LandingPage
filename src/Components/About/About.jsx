        ...
        <section id="about">
            <div className='About'>
                <div className='AboutContainer'>
                    <h1 className='AboutTitle'>Hola! Soy Alejo <br/>
                    Desarrollador de Software Junior Construyendo soluciones digitales con conocimientos técnicos sólidos</h1>
                    
                        <div className="ImageContainer">
                    <img src="https://i.postimg.cc/Xvf9m3n8/Alejo.jpg" alt="Alejo FullStack" />
                     </div>
...
Si estás interesado en colaborar o tienes alguna pregunta, no dudes en contactarme. Estoy abierto a oportunidades y desafíos en el desarrollo de software y el mantenimiento electromecánico.

Gracias por visitar mi página y conocer más sobre mi experiencia y habilidades. Espero tener la oportunidad de trabajar contigo en proyectos futuros.</p>
                </div>
            </div>
        </section>
    )
